...
extension MyLibrary {
    public class Crypto {
        ///加密 : AES
        static func encryptLicensePlate(licensePlate: [[String: String]], key: String) throws -> Data? {
        ...
        ///解密 : AES
        static func decryptLicensePlate(encryptedData: Data, key: String) throws -> [[String: String]]? {
            let symmetricKey = SymmetricKey(data: Data(key.utf8))
